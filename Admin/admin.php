...
if (!isset($_SESSION['loggedin']) || $_SESSION['roll'] != 'Dean') {
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <article>
                ...
                <div class="news-actions">
                    ...
                    <a href="delete_news.php?id=<?php echo $row['NewsID']; ?>" class="abutton" onclick="return confirm('Are you sure you want to delete this news?');"><i class="fa fa-trash"></i> Delete
                    </a>
                </div>
            </article>
        <?php endwhile; ?>
